# Project Backlog & Roadmap — D0ur4tt0 Cybersecurity Blog

This document tracks upcoming features, enhancements, and tasks for [blog.vigly.io](https://blog.vigly.io).

---

## 📌 Active / In Progress

- [x] **Theme Migration:** Migrated to Chirpy Gem v7.6.0 with `chirpy-starter` clean structure.
- [x] **Dark Mode Default:** Enforced permanent dark mode across all devices.
